/*
 *  piano/osc.h — logue-sdk Processor adapter around PianoEngine.
 */
#pragma once
...
class Osc : public Processor {
 public:
  ...
  const char *getParameterStrValue(uint8_t index, int32_t value) const override final {
    static const char *kPresets[PianoEngine::kNumPresets] = {"GRND", "BRIT", "MELO", "HONK", "TOY"};
    if (index == PianoEngine::P_PRESET && value >= 0 && value < PianoEngine::kNumPresets)
