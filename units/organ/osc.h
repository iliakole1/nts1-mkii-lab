/*
 *  organ/osc.h — logue-sdk Processor adapter around OrganEngine.
 */
#pragma once
...
class Osc : public Processor {
 public:
  ...
  const char *getParameterStrValue(uint8_t index, int32_t value) const override final {
    static const char *kPresets[OrganEngine::kNumPresets] = {"JAZZ", "ROCK", "VOX", "FARF", "PIPE", "THTR"};
    if (index == OrganEngine::P_PRESET && value >= 0 && value < OrganEngine::kNumPresets)
