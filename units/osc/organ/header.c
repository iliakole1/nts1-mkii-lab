/*
 *  organ/header.c — unit metadata and parameter descriptors.
 *
 ...
 *
 *  Parameter order must match OrganEngine::ParamId.
 */
...
const __unit_header unit_header_t unit_header = {
    ...
    .params = {
        ...
        {0, 5, 0, 0, k_unit_param_type_strings, 0, 0, 0, {"PRST"}},
        {0, 1023, 0, 520, k_unit_param_type_none, 0, 0, 0, {"TONE"}},
        {0, 100, 0, 100, k_unit_param_type_percent, 0, 0, 0, {"VIB"}},
        {0, 100, 0, 100, k_unit_param_type_percent, 0, 0, 0, {"PERC"}},
        {0, 100, 0, 12, k_unit_param_type_percent, 0, 0, 0, {"DRIV"}},
