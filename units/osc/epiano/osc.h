/*
 *  epiano/osc.h — logue-sdk Processor adapter around EPianoEngine.
 */
#pragma once
...
class Osc : public Processor {
 public:
  ...
  const char *getParameterStrValue(uint8_t index, int32_t value) const override final {
    static const char *kPresets[EPianoEngine::kNumPresets] = {"RHDS", "WURL", "DYNO", "BARK"};
    if (index == EPianoEngine::P_PRESET && value >= 0 && value < EPianoEngine::kNumPresets)
