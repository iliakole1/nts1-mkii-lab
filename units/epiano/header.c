/*
 *  epiano/header.c — unit metadata and parameter descriptors.
 *
 ...
 *
 *  Parameter order must match EPianoEngine::ParamId.
 */
...
const __unit_header unit_header_t unit_header = {
    ...
    .params = {
        ...
        {0, 3, 0, 0, k_unit_param_type_strings, 0, 0, 0, {"PRST"}},
        {0, 1023, 0, 430, k_unit_param_type_none, 0, 0, 0, {"TONE"}},
        {0, 100, 0, 100, k_unit_param_type_percent, 0, 0, 0, {"TREM"}},
        {0, 100, 0, 20, k_unit_param_type_percent, 0, 0, 0, {"DRIV"}},
