/*
 *  flute/osc.h — logue-sdk Processor adapter around FluteEngine.
 */
#pragma once
...
class Osc : public Processor {
 public:
  ...
  const char *getParameterStrValue(uint8_t index, int32_t value) const override final {
    static const char *kPresets[FluteEngine::kNumPresets] = {"FLUT", "OCAR", "PANF", "RECD", "PICC"};
    if (index == FluteEngine::P_PRESET && value >= 0 && value < FluteEngine::kNumPresets)
