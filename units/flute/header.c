/*
 *  flute/header.c — unit metadata and parameter descriptors.
 *
 ...
 *
 *  Parameter order must match FluteEngine::ParamId.
 */
...
const __unit_header unit_header_t unit_header = {
    ...
    .params = {
        ...
        {0, 1023, 0, 500, k_unit_param_type_none, 0, 0, 0, {"TONE"}},
        {0, 100, 0, 30, k_unit_param_type_percent, 0, 0, 0, {"LOFI"}},
        {0, 100, 0, 50, k_unit_param_type_percent, 0, 0, 0, {"VSEN"}},
